...
const op_info OPERATORS_INFO[] = {
    ...
    {OPERATORS::OP_SH,  "sh",  2, "OP_SH",  2,  "\\sh(" ,  NULL ,      ")", DIFFERENCIATOR(DiffSh,)  CALCUL(CalcSh) },
    {OPERATORS::OP_CH,  "ch",  2, "OP_CH",  2,  "\\ch(" ,  NULL ,      ")", DIFFERENCIATOR(DiffCh,)  CALCUL(CalcCh) },
    {OPERATORS::OP_TH,  "th",  2, "OP_TH",  2,  "\\th(" ,  NULL ,      ")", DIFFERENCIATOR(DiffTh,)  CALCUL(CalcTh) },
    {OPERATORS::OP_CTH, "cth", 3, "OP_CTH", 2,  "\\cth(" , NULL ,      ")", DIFFERENCIATOR(DiffCth,) CALCUL(CalcCth)}
};
