...
\end{definition}
{\large \At first the derivatives must be calcutated:}}
\textbf{Let's calculate a simple derivative:}
\begin{dmath}
cos(sin(x)) + x^{3.00}\end{dmath}
It is common knowledge:
...
\begin{dmath}
(
-1.00 \cdot sin(x) \cdot -1.00 \cdot sin(sin(x)))' = 
-1.00 \cdot cos(x) \cdot -1.00 \cdot sin(sin(x)) + -1.00 \cdot sin(x) \cdot -1.00 \cdot cos(x) \cdot cos(sin(x))\end{dmath}
According to the theorem (which number?) from paragraph ??:
\begin{dmath}
(
cos(x))' = 
...
\begin{dmath}
(
cos(x) \cdot cos(sin(x)))' = 
-1.00 \cdot sin(x) \cdot cos(sin(x)) + cos(x) \cdot cos(x) \cdot -1.00 \cdot sin(sin(x))\end{dmath}
Understanding this transformation is left to the reader as a simple exercise:
\begin{dmath}
(
-1.00 \cdot cos(x) \cdot cos(sin(x)))' = 
-1.00 \cdot (-1.00 \cdot sin(x) \cdot cos(sin(x)) + cos(x) \cdot cos(x) \cdot -1.00 \cdot sin(sin(x)))\end{dmath}
Understanding this transformation is left to the reader as a simple exercise:
\begin{dmath}
(
cos(x) \cdot -1.00 \cdot cos(x) \cdot cos(sin(x)))' = 
-1.00 \cdot sin(x) \cdot -1.00 \cdot cos(x) \cdot cos(sin(x)) + cos(x) \cdot -1.00 \cdot (-1.00 \cdot sin(x) \cdot cos(sin(x)) + cos(x) \cdot cos(x) \cdot -1.00 \cdot sin(sin(x)))\end{dmath}
It is obvious that:
\begin{dmath}
(
-1.00 \cdot sin(x) \cdot -1.00 \cdot sin(sin(x)) + cos(x) \cdot -1.00 \cdot cos(x) \cdot cos(sin(x)))' = 
-1.00 \cdot cos(x) \cdot -1.00 \cdot sin(sin(x)) + -1.00 \cdot sin(x) \cdot -1.00 \cdot cos(x) \cdot cos(sin(x)) + -1.00 \cdot sin(x) \cdot -1.00 \cdot cos(x) \cdot cos(sin(x)) + cos(x) \cdot -1.00 \cdot (-1.00 \cdot sin(x) \cdot cos(sin(x)) + cos(x) \cdot cos(x) \cdot -1.00 \cdot sin(sin(x)))\end{dmath}
Understanding this transformation is left to the reader as a simple exercise:
\begin{dmath}
(
2.00 \cdot x)' = 
...
\begin{dmath}
(
3.00 \cdot 2.00 \cdot x)' = 
6.00\end{dmath}
It is obvious that:
\begin{dmath}
(
-1.00 \cdot sin(x) \cdot -1.00 \cdot sin(sin(x)) + cos(x) \cdot -1.00 \cdot cos(x) \cdot cos(sin(x)) + 3.00 \cdot 2.00 \cdot x)' = 
-1.00 \cdot cos(x) \cdot -1.00 \cdot sin(sin(x)) + -1.00 \cdot sin(x) \cdot -1.00 \cdot cos(x) \cdot cos(sin(x)) + -1.00 \cdot sin(x) \cdot -1.00 \cdot cos(x) \cdot cos(sin(x)) + cos(x) \cdot -1.00 \cdot (-1.00 \cdot sin(x) \cdot cos(sin(x)) + cos(x) \cdot cos(x) \cdot -1.00 \cdot sin(sin(x))) + 6.00\end{dmath}
\textbf{Let's calculate a simple derivative:}
\begin{dmath}
cos(x) \cdot -1.00 \cdot sin(sin(x)) + 3.00 \cdot x^{2.00}\end{dmath}
According to the theorem (which number?) from paragraph ??:
...
\begin{dmath}
T(x \cdot sin(x)) = 1.00 + -0.50 \cdot x^{2.00} + -0.04 \cdot x^{4.00} + 0.05 \cdot x^{5.00} + -0.00 \cdot x^{6.00} + 0.00 \cdot x^{7.00} + ...\end{dmath}
\end{document}
