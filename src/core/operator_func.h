...
const op_info OPERATORS_INFO[] = {
    ...
    {OP_ARCSIN, "arcsin", 6, "OP_ARCSIN", 2,  "\\arcsin(",               NULL ,      ")", DIFFERENCIATOR(DiffArcsin,) CALCUL(CalcArcsin)},
    {OP_ARCCOS, "arccos", 6, "OP_ARCCOS", 2,  "\\arccos(",               NULL ,      ")", DIFFERENCIATOR(DiffArccos,) CALCUL(CalcArccos)},
    {OP_ARCTG,  "arctg",  5, "OP_ARCTG",  2,  "\\arctan(",               NULL ,      ")", DIFFERENCIATOR(DiffArctg,)  CALCUL(CalcArctg)},
    {OP_ARCCTG, "arcctg", 6, "OP_ARCCTG", 2,  "\\operatorname{arccot}(", NULL ,      ")", DIFFERENCIATOR(DiffArcctg,) CALCUL(CalcArcctg)}
};
