...
clean:
	rm -f diff output/*.tex output/*.aux output/*.log *.tex *.aux *.log src/calculation_optimization/*.o src/core/*.o src/differenciation/*.o src/dump/*.o src/utils/*.o src/io/*.o src/*.o *.o output/images/*.dot output/images/*.svg
